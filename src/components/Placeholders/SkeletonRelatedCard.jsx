...
function SkeletonRelatedCard() {
  return (
    ...
    >
      ...
      <div class="w-full pt-3 ml-0">
        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-40 mb-2 pt-2"></div>
        <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-32 max-w-[350px] "></div>
      </div>
