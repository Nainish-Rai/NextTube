...
function SkeletonVideoDetails() {
  return (
    <div className="w-full lg:w-[65%] lg:ml-14">
      ...
      >
        <div class="flex items-center justify-center w-full lg:h-96 aspect-video bg-gray-300 rounded-3xl overflow-hidden  dark:bg-gray-700">
        ...
        <div class="w-full pt-12">
          <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-96 mb-4"></div>
          <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[720px] mb-2.5"></div>
          <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[700px] mb-2.5"></div>
          <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[680px] mb-2.5"></div>
