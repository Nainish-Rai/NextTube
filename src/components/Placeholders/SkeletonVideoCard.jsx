  ...
  return (
    ...
    >
      ...
      <div class="flex items-center mt-4 space-x-3">
        ...
        <div>
          <div class="sm:mx-0 mx-2 w-72 h-2 bg-gray-200 rounded-full dark:bg-gray-700"></div>
          <div class="sm:mx-0 mx-2 w-72 h-2 bg-gray-200 rounded-full dark:bg-gray-700 mt-2"></div>
          <div class="h-2.5 sm:mx-0 mx-2  bg-gray-200 rounded-full dark:bg-gray-700 w-32 mt-2"></div>
        </div>
      </div>
