...
const PlaylistCard = ({
  ...
  return (
    <div className="w-full xl:w-1/4 lg:w-1/4 md:w-1/3 p-3 cursor-pointer">
      {/* <Link to="/video/:id"> */}
      <div
      ...
      >
        ...
        <div onClick={() => handlePlaylistClick("")} className="relative w-full">
          <img
            ...
            src={thumbnail}
          />
          <div className="absolute bg-gray-800 bg-opacity-50 backdrop-blur-sm bottom-0 flex justify-center items-center font-semibold right-0 w-28 h-full z-10">{videoCount}</div>
