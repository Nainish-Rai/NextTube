...
const VideoDetails = () => {
  ...
  if (true) {
    return (
      <div className="lg:pt-20 pt-9  mx-auto w-full  flex flex-wrap bg-black h-screen overflow-scroll scrollbar-hide justify-start gap-10 ">
        {/* Left Side */}

        <div className="leftside w-full lg:w-[65%] lg:ml-8 ">
